...
export class SingleServiceComponent implements OnInit {
  ...
  // }
   ...
   fetchSiteRank(url){
    ...
    this.http.get<any>(`https://www.paymentor.io/api?Output=json&Action=UrlInfo&Count=10&ResponseGroup=Rank,LinksInCount&Start=1&Url=${url}`, { headers: headers }).subscribe(res => {
